...
public:
        ...
        std::queue<std::vector<int>>& queueUpdateLabels_left, std::queue<bool>& queueYolo_tracker2seq_left, std::queue<bool>& queueYolo_seq2tri_left)
    {
        ...
        std::cout << "start updating sequential data" << std::endl;
        ...
        std::cout << "get target data" << std::endl;
        /* data available */
        if (ret)
        {
            ...
            if (!dataLeft.empty())
            {
                ...
                std::cout << "finish updatind data" << std::endl;
                //new data added
                ...
                {
                    std::cout << "updated Yolo data is available" << std::endl;
